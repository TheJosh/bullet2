...
public:
	...
	static void copyArrayToDevice(cl_mem device, const void* host, unsigned int size);
	static void copyArrayFromDevice(void* host, const cl_mem device, unsigned int size);
