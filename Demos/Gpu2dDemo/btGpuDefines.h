...
static inline float4 bt3dGrid_make_float4(float x, float y, float z, float w)
{
  float4 t; t.x = x; t.y = y; t.z = z; t.w = w; return t;
}
#define BT_GPU_make_float4(x, y, z, w) bt3dGrid_make_float4(x, y, z, w)
...
static inline float bt3dGrid_dot(float4& a, float4& b)
{
...
static inline float4 bt3dGrid_cross(const float4& a, const float4& b)
{
	float4 r; r.x = a.y*b.z-a.z*b.y; r.y = -a.x*b.z+a.z*b.x; r.z = a.x*b.y-a.y*b.x;r.w = 0.f; 	return r;
}
